...
public final class DoubledSlider: UIControl {
    public struct Constant {
        ...
        let trackForegroundImage: UIImage = UIImage(named: "Rectangle 233")!
    ...
    var trackBackgroundColor: UIColor {
        if #available(iOS 12.0, *) {
            if traitCollection.userInterfaceStyle == .light {
                ...
                return UIColor(red: 0.118, green: 0.745, blue: 0.745, alpha: 1)
            } else {
                // swiftlint:disable force_unwrapping
                return .white
            }
    ...
    private lazy var leftThumb = UIImageView(image: UIImage(named: "Ellipse 15")!)
    private lazy var rightThumb = UIImageView(image: UIImage(named: "Ellipse 15")!)
    ...
    private func setupTrack() {
        ...
        track.layer.borderColor = UIColor(red: 0.738, green: 0.741, blue: 1, alpha: 1).cgColor
